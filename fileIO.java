...
public class fileIO {
	...
	private File file; // File we are currently using //
	...
	/*
	 * initialises all info needed fo file io
	 */
	public fileIO(Scanner input, Scanner sc) 
	{
		...
		lines = new String[12];//no time to sort this out, neede to be hard-coded 
