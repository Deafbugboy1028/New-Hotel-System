...
public class deskAdmin extends User {
	...
	System.out.println("Hello DeskAdmin. Please enter correct password to login to L4 Hotel's Reservation System.");
		...
		case 1: 
			...
			while (true) {
				...
				hotels.get(hotelChoice - 1).getRoomList()
						.get(roomChoice - 1).setCurrentAdults(adults);
				break;
			}
			...
			System.out.println("And finally, what day of the week will they be arriving.");
